<template>
    <form @submit.prevent="create">
      <div>Username: <input v-model="studentForm.username" type="text" /></div>
      <div>Password:<input v-model="studentForm.password" type="password" /></div>
      <div>Name: <input v-model="studentForm.name" type="text" /></div>
      <div>E-mail: <input v-model="studentForm.email" type="text" /></div>
      <div>
        Course:
